...
[![CI](https://github.com/hanax-ai/hx-citadel-ansible/actions/workflows/ci.yml/badge.svg)](https://github.com/hanax-ai/hx-citadel-ansible/actions/workflows/ci.yml)
...
For multi-node setups, you can bind to additional IP addresses:

```yaml
redis_bind_interface: "127.0.0.1 {{ redis_additional_bind_ip | default('') }}"
redis_additional_bind_ip: "192.168.10.48"  # Example: specific server IP
```
