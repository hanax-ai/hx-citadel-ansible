...
class Settings(BaseSettings):
    ...
    # Qdrant
    qdrant_url: str = Field(default="https://hx-vectordb-server.dev-test.hana-x.ai:6333")
    ...
    # LLM (via LiteLLM)
    llm_api_base: str = Field(default="http://hx-litellm-server.dev-test.hana-x.ai:4000/v1")
