...
class TestCircuitBreakerWithHTTP:
    ...
    async def test_circuit_breaker_with_successful_http_call(self, mock_http, orchestrator_url):
        ...
        mock_http.post(f"{orchestrator_url}/test").respond(
            json={"status": "success"}
        )
    ...
    async def test_circuit_breaker_with_http_failures(self, mock_http, orchestrator_url):
    ...
    async def test_circuit_breaker_protects_against_timeouts(self, mock_http, orchestrator_url):
        ...
        mock_http.post(f"{orchestrator_url}/test").mock(side_effect=httpx.TimeoutException("Timeout"))
